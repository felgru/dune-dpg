...
#ifndef DUNE_LOCALFUNCTIONS_QkDISCONTUNUOUSLOCALINTERPOLATION_HH
#define DUNE_LOCALFUNCTIONS_QkDISCONTINUOUSLOCALINTERPOLATION_HH
...
namespace Dune
{
  ...
  class QkDiscontinuousLocalInterpolation
  {
  ...
  class QkDiscontinuousLocalInterpolation<0,d,LB>
  {
  public:
    //! \brief Local interpolation of a function
    template<typename F, typename C>
